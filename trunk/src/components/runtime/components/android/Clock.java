...
public final class Clock extends AndroidNonvisibleComponent
    implements Component, AlarmHandler, OnStopListener, OnResumeListener, Deleteable {
   ...
   */
  @DesignerProperty(editorType = DesignerProperty.PROPERTY_TYPE_INTEGER, defaultValue = "1000")
  @SimpleProperty
